...
#   python ../scripts/compare_pig5fps.py
...
BASELINE = "pig5fps_bytetrack_detonly"   # or "baseline_detonly"
...
print("\n=== Pig5fps comparison (COMBINED) ===")
print(view.to_string(index=False))

out_csv = os.path.join(TRACK_EVAL_ROOT, f"pig5fps_compare_COMBINED_vs_{BASELINE}.csv")
